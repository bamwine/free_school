                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select name="teacher_id" class="form-control">
                                ...
                                ?>
             <option value="<?php echo $row2['teacher_id'];?>"  <?php if($row['teacher_id'] == $row2['teacher_id'])echo 'selected';?>>  <?php echo $row2['name'];?>
                                                </option>
                                <?php
                                endforeach;
                                ?>
					...
					<div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="class_level" class="form-control " style="width:100%;">
                                    	<option value=""><?php echo get_phrase('select');?></option>
										<option value="o" <?php if($row['class_level'] == 'o') echo 'selected';?>>O-level</option>
										<option value="a" <?php if($row['class_level'] == 'a') echo 'selected';?>>A-level</option>
									</select>
                                </div>
                            </div>
            		<div class="form-group">
