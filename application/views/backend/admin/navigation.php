<div class="sidebar-menu">
    <header class="logo-env" >
        ...
        <div class="logo" style="">
            <a href="<?php echo base_url(); ?>">
                <img src="uploads/dd.jpg"  style="max-height:60px;"/>
            </a>
        </div>
    ...
    <ul id="main-menu" class="">
        ...
        if ($page_name == 'exam' ||
                ...
                $page_name == 'marks' ||
                    $page_name == 'exam_marks_sms' ||
                        $page_name == 'tabulation_sheet'||$page_name == 'aggre'||$page_name=='priority')
                            echo 'opened active';
        ?> ">
            <a href="#">
            ...
            <ul>
                <li class="<?php if ($page_name == 'exam') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/exam">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('EXAM  LIST'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'grade') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/grade">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('GRADING  CRITERIA '); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'marks') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/marks">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('MANAGE  MARKS'); ?></span>
                    </a>
                </li>
                ...
                <li class="<?php if ($page_name == 'tabulation_sheet') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/tabulation_sheet">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('TABULATION SHEET'); ?></span>
                    </a>
                </li>
				<li class="<?php if ($page_name == 'aggre') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/aggre">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('AGGREGATE CRITERIA '); ?></span>
                    </a>
                </li>
				<li class="<?php if ($page_name == 'priority') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/priority">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('SUBJECT  RULES '); ?></span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <!-- SETTINGS -->
        <li class="<?php
        if ($page_name == 'system_settings' || $page_name == 'school_settings' ||  $page_name == 'backup_restore' ||
            ...
            <ul>
				...
				<li class="<?php if ($page_name == 'backup_restore') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/backup_restore">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('Back Up'); ?></span>
                    </a>
                </li>
            </ul>
        </li>
