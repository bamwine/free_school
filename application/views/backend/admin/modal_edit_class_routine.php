...
<form action="<?php echo base_url();?>index.php?admin/class_routine/do_update/<?php echo $rowdata['class_routine_id']?>" class="form-horizontal validatable" target="_top" method="post" accept-charset="utf-8">
