...
<div class="col-sm-9">
<select name="student_id" required class="form-control" style="width:100%;" id="student_selection_holder">
...
<div class="col-sm-9">
<input type="text" required class="datepicker form-control" name="date">
</div>
</div>
</div>
</div>
...
<div class="col-sm-9">
<input type="number" class="form-control" required name="amount" id="amount" placeholder="Enter Fees Amount">
</div>
</div>
<div class="form-group">
<label class="col-sm-3 control-label">payment</label>
<div class="col-sm-9">
<input type="number" class="form-control" required name="amount_paid" placeholder="Enter Payment Amount">
</div>
</div>
<div class="form-group">
...
<label class="col-sm-3 control-label">Total</label>
<div class="col-sm-9">
<input type="number"  required class="form-control " name="amount"  id="amount2" placeholder="Enter Total Fees">
</div>
</div>
<div class="form-group">
<label class="col-sm-3 control-label">payment</label>
<div class="col-sm-9">
<input type="number" required class="form-control" name="amount_paid" placeholder="Enter Payment Amount">
</div>
</div>
<div class="form-group">
<label class="col-sm-3 control-label">status</label>
...
<script type="text/javascript">
    function get_class_students(class_id) {
        $.ajax({
		 ...
		 $.ajax({
            url: 'index.php?admin/get_fess/' + class_id ,
            success: function(response)
            {
