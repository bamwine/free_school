		...
		<ul class="nav nav-tabs bordered">
			<li class="active">
            	<a href="#list" data-toggle="tab"><i class="entypo-menu"></i> 
					<?php echo get_phrase('subject list');?>
                    	</a></li>
			<li>
            	<a href="#add" data-toggle="tab"><i class="entypo-plus-circled"></i>
					<?php echo get_phrase('add subject');?>
                    	</a></li>
		</ul>
    	<!------CONTROL TABS END------>
...
<label class="col-sm-3 control-label"><?php echo get_phrase('Subject Name');?></label>
...
<option value="-seven">seven</option>
                            ...
                            <div class="col-sm-offset-3 col-sm-5">
                                <button type="submit" class="btn btn-info"><?php echo get_phrase('add subject');?></button>
                            </div>
						</div>
                    </form>                
                </div>                
